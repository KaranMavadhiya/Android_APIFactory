...
public class OkHttpHelper {
     ...
     * @return WSResponse
     */
    public WSResponse callHttpSyncPost(Context context, String url, RequestBody requestBody) throws IOException {
        WSResponse wsResponse = new WSResponse();
     ...
     * @return WSResponse
     */
    public WSResponse callHttpSyncMultiPart(final Context context, final String url, final RequestBody requestBody) throws IOException {
        WSResponse wsResponse = new WSResponse();
     ...
     * @return WSResponse
     */
    public WSResponse callHttpSyncGet(final Context context, final String url) throws IOException {
        WSResponse wsResponse = new WSResponse();
